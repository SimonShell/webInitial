        ...
        <div :class="[prefixCls + '-body']">
            <div :class="[prefixCls + '-content', prefixCls + '-content-left']">
                <div :class="[timePrefixCls + '-header']">
                    ...
                    <template v-else>{{ t('datepicker.startTime') }}</template>
                </div>
                <TimeSpinner
                    ref="timeSpinner"
                    :steps="steps"
            ...
            <div :class="[prefixCls + '-content', prefixCls + '-content-right']">
                <div :class="[timePrefixCls + '-header']">
                    ...
                    <template v-else>{{ t('datepicker.endTime') }}</template>
                </div>
                <TimeSpinner
                    ref="timeSpinnerEnd"
                    :steps="steps"
...
<script>
    ...
    const prefixCls = 'yy-picker-panel'
    const timePrefixCls = 'yy-time-picker'
    export default {
        name: 'YYRangeTimePickerPanel',
        ...
        methods: {
            panelLabelConfig(date) {
                ...
                const {
                    labels,
                    separator
                } = formatDateLabels(locale, datePanelLabel, date || initTimeDate())
